...
namespace RVO {
	...
	void Agent::computeNewVelocity()
	{
		...
		size_t lineFail = linearProgram2(orcaLines_, abs(prefVelocity_), prefVelocity_, false, newVelocity_);

		if (lineFail < orcaLines_.size()) {
			linearProgram3(orcaLines_, numObstLines, lineFail, abs(prefVelocity_), newVelocity_);
		}
	}
